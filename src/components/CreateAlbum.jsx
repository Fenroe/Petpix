      ...
      <div className="flex flex-col bg-white fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-50 p-3 w-[480px] h-auto rounded-lg overflow-auto dark:bg-black dark:text-white">
        ...
        <div className="mx-10 p-3 h-full">
          <div className="relative border-2 border-slate-400 mt-8 focus-within:border-blue-500">
            <input ref={inputRef} required type="text" className="w-full px-3 pt-5 min-h-[64px] text-lg outline-none bg-none peer dark:bg-black dark:text-white" onChange={updateTitle} />
          ...
          <div className="flex bg-white justify-center w-full bottom-0 mt-3 dark:bg-black">
