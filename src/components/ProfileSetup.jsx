...
export const ProfileSetup = () => {
  ...
  return ReactDOM.createPortal(
    <>
      ...
      <div ref={modalRef} className="h-[650px] flex flex-col bg-white fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-50 p-3 w-[480px] rounded-lg overflow-auto pb-10 dark:bg-black dark:text-white">
        ...
        <form className="flex flex-col mt-8" noValidate action="">
          <div className="relative border-2 border-slate-400 focus-within:border-blue-500">
            <input ref={usernameRef} onBlur={validateUsername} required type="text" className="w-full px-3 pt-5 min-h-[64px] text-lg outline-none bg-none peer dark:bg-black" />
          ...
          <div className="relative border-2 border-slate-400 focus-within:border-blue-500">
            <TextareaAutosize ref={bioRef} onChange={validateBio} required className="w-full px-3 pt-7 min-h-[64px] text-lg outline-none bg-none peer resize-none dark:bg-black" />
          ...
          <div className="relative border-2 border-slate-400 focus-within:border-blue-500">
            <input ref={locationRef} onChange={validateLocation} required type="text" className="w-full px-3 pt-5 min-h-[64px] text-lg outline-none bg-none peer dark:bg-black" />
